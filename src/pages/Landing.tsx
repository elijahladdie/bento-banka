      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="hero" onClick={() => navigate("/signup")}>Open Account</Button>
          </div>
        </div>
      </nav>
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="bento-card max-w-3xl mx-auto py-16 px-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="hero" size="lg" className="px-8 text-base" onClick={() => navigate("/signup")}>
                Open an Account <ArrowRight className="ml-1 h-5 w-5" />
              </Button>
              <Button variant="hero-outline" size="lg" className="px-8 text-base" onClick={() => navigate("/login")}>
                Sign In
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          <div className="bento-grid-4">
            {stats.map((s) => {
              ...
              return (
                <div key={s.label} ref={ref} className="bento-card text-center">
                  <div className="stat-value">
                    {s.value === 99.9 ? "99.9" : count.toLocaleString()}{s.suffix}
                  </div>
